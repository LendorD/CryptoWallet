package len.crypto.Wallet.SOL.connector;
...
public class SolConnector {
    ...
    private final SolSource solSource;



    public long getBlockNumber() {
        Supplier<ResponseEntity<String>> func = () -> solSource.getBlockNumber();
    ...
    public BigInteger getTransactionCount(String address) {
        Supplier<ResponseEntity<String>> func = () -> solSource.getTransactionsInBlock(address);
        ResponseEntity<String> response = execute(func);
    ...
    public String getTokenAccountByOwner(String tokenAddress, String ownerAddress) {
        Supplier<ResponseEntity<String>> func = () -> solSource.getTokenAccountByOwner(tokenAddress, ownerAddress);
    ...
    public String getLatestBlockhash() {
        Supplier<ResponseEntity<String>> func = () -> solSource.getLatestBlockhash();
    ...
    public String sendRawTransaction(String hexValue) throws RuntimeException{
        Supplier<ResponseEntity<String>> func = () -> solSource.sendRawTransaction(hexValue);
    ...
    public BigDecimal getBalance(String address) {
        Supplier<ResponseEntity<String>> func = () -> solSource.getBalance(address);
    ...
    public Block getBlockByNumber(long number) {
        Supplier<ResponseEntity<String>> func = () -> solSource.getBlockByNumber(number);
    ...
    public ConfirmedTransaction getTransaction(String hash) {
        Supplier<ResponseEntity<String>> func = () -> solSource.getTransactionByHash(hash);
    ...
    public BigDecimal getTokenBalance(String address) {
        Supplier<ResponseEntity<String>> func = () -> solSource.getTokenBalance(address);
    ...
    public List<String> getInputs(String txid) {
        Supplier<ResponseEntity<String>> func = () -> solSource.getTransactionsInBlock(txid);
    ...
    public Boolean isTransactionExists(String txid) {
        Supplier<ResponseEntity<String>> func = () -> solSource.getTransactionByHash(txid);
