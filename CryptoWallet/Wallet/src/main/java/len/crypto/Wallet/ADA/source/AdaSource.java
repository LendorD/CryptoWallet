package len.crypto.Wallet.ADA.source;

import len.crypto.Wallet.ADA.handler.exception.AdaRPCExceptionHandler;
import len.crypto.Wallet.ADA.handler.response.AdaRPCResponseHandler;
...
public class AdaSource {
    public RestTemplate restTemplate;
    private final AdaRPCExceptionHandler exceptionHandler;
    private final AdaRPCResponseHandler responseHandler;
